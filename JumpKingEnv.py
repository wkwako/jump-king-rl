...
class JumpKingEnv(gym.Env[np.ndarray, Union[int, np.ndarray]]):
    ...
    def __init__(self, episode_mode, max_episode_actions=20, curriculum_screens=5, spacing=0.05, per_screen=False, action_map=None, current_screen=None, dummyenv=False, play=False, action_cutoff=22):
        ...
        self.falling_screen_penalty = -150
        self.jumped = False
        ...
        self.wind_screen_reward = 150 #was 500
        self.wind_screen_penalty = -150 #was -300
        ...
        self.wind_action_cutoff_penalty = -200 #was -1000
    ...
    def step(self, action):
        ...
        #wind-specific rewards and penalties. penalty for agent if noops for entire wind cycle
    ...
    def new_screen_reward(self, dist_rewards=False):
        reward = 0
        ...
        #fell. apply penalty
        elif not self.current_screen == self.expected_screen:
            if self.expected_screen in static_variables.WIND_SCREENS:
            ...
            if not dist_rewards:
                ...
                if self.proximity_rewards:
                    prox_reward = self.get_goal_proximity_reward()
                    reward += -prox_reward
                    print (f"Reverting proximity penalty: {-prox_reward}")
    ...
    def build_state_per_screen(self):
        ...
        elif self.expected_screen in static_variables.ONEHOT_SCREENS:
        ...
        elif self.expected_screen == 37:
            return np.array([self.x, self.y % 360, self.vel_x], dtype=np.float32)
